...
public class DangNhap implements Initializable{
	...
	public void btnLogin(ActionEvent e) throws IOException {
		if(txtUser.getText().toString().equals("admin") && txtPass.getText().toString().equals("123")) {
			...
			AdminController ctlMain=loader.getController();
			ctlMain.ThietLapTenNguoiDangNhap(txtUser.getText().toString());
			...
			FXMLLoader loader=new FXMLLoader(getClass().getResource("/fxml/NhanVien.fxml"));

			Parent root=loader.load();

			NhanVienController ctlMain=loader.getController();
			ctlMain.ThietLapTenNguoiDangNhap(txtUser.getText().toString());
			...
			FXMLLoader loader=new FXMLLoader(getClass().getResource("/fxml/KeToan.fxml"));

			Parent root=loader.load();

			KeToanController ctlMain=loader.getController();
			ctlMain.ThietLapTenNguoiDangNhap(txtUser.getText().toString());
